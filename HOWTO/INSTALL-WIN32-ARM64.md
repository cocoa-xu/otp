...
This is the short story though, for the experienced and impatient:
    ...
    *   Get and install complete WSL2 environment
...
Building is easiest using the `otp_build` script:
    ...
    $ ./otp_build configure --disable-jit --disable-native-ethr-impls --disable-smp-require-native-atomics <optional configure options>
    $ ./otp_build boot -a
